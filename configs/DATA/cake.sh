#!/bin/sh
######################################################################
#  (C) 2022 Modded By Eliminater74 For PureFusionWRT                 #
#                                                                    #
# Date Updated: 07/21/2022                                           #
#                                                                    #
#   Cake:                                                            #
#  Original: https://github.com/Last-times/CAKE-QoS-Script-OpenWrt   #
#                                                                    #
#   AutoSQM:                                                         #
#  Original: https://github.com/baguswahyu/autoSQM-damasus.bagus     #
######################################################################
 ...
 #convert to Mbps & adjust to 90% speed
 downloadMbps=$(awk "BEGIN {download = $download; print download*1*90/100}")
 uploadMbps=$(awk "BEGIN {upload = $upload; print upload*1*90/100}")
 echo "$downloadMbps"
 echo "$uploadMbps"
...
### CAKE settings ###
echo "setting up Cake with new value"
BANDWIDTH_DOWN="${downloadMbps%%.*}"    # Change this to about 80-95% of your download speed (in megabits).
BANDWIDTH_UP="${uploadMbps%%.*}"        # Change this to about 80-95% of your upload speed (in megabits).
...
IPV4_GAME_CONSOLES_STATIC_IP="192.168.1.2, 192.168.1.4-192.168.1.100"
...
IPV4_TORRENTBOX_STATIC_IP="192.168.1.3"
...
###########################################################
 echo "auto cake  DONE!"
logger -t cake -p info "Set download = $downloadMbps, upload = $uploadMbps"